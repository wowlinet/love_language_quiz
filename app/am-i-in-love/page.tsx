...
export default function AmIInLovePage() {
  ...
  const handleSocialShare = (platform: string) => {
    ...
    const text = encodeURIComponent(
      `I just took the "Am I in Love?" quiz and got: ${result.title} (${percentage}% love score)! 💕\n\nTake the quiz to discover your feelings!`
    )
    const url = encodeURIComponent(window.location.origin + '/am-i-in-love')
    ...
    switch (platform) {
      ...
      case 'telegram':
        ...
        break
      case 'copy':
        const copyText = `I just took the "Am I in Love?" quiz and got: ${result.title} (${percentage}% love score)! 💕\n\nTake the quiz to discover your feelings!\n\n${window.location.origin}/am-i-in-love`
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 animate-scale-in" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Let others discover their feelings too!
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 mb-6 border border-rose-200">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-1">Your Love Assessment</p>
                  <p className="text-2xl font-bold text-rose-600 mb-1">{result.title}</p>
                  <p className="text-lg font-semibold text-gray-700">
                    {percentage}% Love Score
                  </p>
                </div>
              </div>
            ...
            <div className="relative text-center">
              ...
              <div className="max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                  ...
                  <span className="text-gray-600 font-medium">Love Score</span>
                </div>
                <p className="text-sm text-white/90 mt-3">{totalScore} out of {maxScore} points</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Understanding your feelings</p>
                </div>
              </div>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Detailed love assessment analysis</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-700 font-semibold text-lg">Overall Love Score</span>
            ...
            <div className="mb-12 p-8 bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 rounded-2xl border-2 border-purple-200 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-purple-700">Guidance based on your results</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
              ...
              >
                ...
                <span className="relative z-10">Love Language Quiz</span>
              </Link>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-amber-800 leading-relaxed">
                    This quiz is for self-reflection and entertainment. Love is complex and unique for everyone. Trust your own feelings and experiences above any quiz result.
                  </p>
                </div>
              </div>
            </div>
