...
import type { LoveQuestion, LoveQuizResult } from '@/lib/loveQuizData'
import { calculateLoveQuizResult } from '@/lib/loveQuizData'
import type { Locale } from '@/i18n/config'
import Link from 'next/link'
import confetti from 'canvas-confetti'

interface AmIInLoveClientProps {
  lang: Locale
  questions: LoveQuestion[]
  results: Record<string, LoveQuizResult>
}

const translations = {
  en: {
    title: 'Am I in Love?',
    subtitle: 'Discover the truth about your feelings with this scientifically-informed quiz. Answer honestly based on how you truly feel.',
    assessmentTitle: 'This Assessment Evaluates:',
    commitment: 'Commitment and future thinking',
    attraction: 'Physical and romantic attraction',
    authenticity: 'Authenticity and vulnerability',
    balance: 'Balance of give and take',
    question: 'Question',
    of: 'of',
    quizCompleted: 'Quiz Completed!',
    yourAssessment: 'Your Love Assessment',
    basedOnAnswers: "Based on your answers, here's what your feelings reveal",
    resultLabel: 'Your Love Assessment Result',
    loveScore: 'Love Score',
    outOf: 'out of',
    points: 'points',
    whatThisMeans: 'What This Means',
    understandingFeelings: 'Understanding your feelings',
    scoreBreakdown: 'Your Score Breakdown',
    detailedAnalysis: 'Detailed love assessment analysis',
    overallLoveScore: 'Overall Love Score',
    deeplyInLove: 'Deeply in Love',
    strongFeelings: 'Strong Feelings',
    developing: 'Developing',
    uncertain: 'Uncertain',
    notInLove: 'Not in Love',
    deeplyInLoveRange: '80-100%',
    strongFeelingsRange: '60-79%',
    developingRange: '40-59%',
    uncertainRange: '20-39%',
    notInLoveRange: '0-19%',
    ...
    disclaimer: 'This quiz is for self-reflection and entertainment. Love is complex and unique for everyone. Trust your own feelings and experiences above any quiz result.',
    shareYourResults: 'Share Your Results',
    letOthersDiscover: 'Let others discover their feelings too!',
    yourLoveAssessment: 'Your Love Assessment',
    shareOn: 'Share on:',
    copyLink: 'Copy Link',
  ...
  de: {
    title: 'Bin ich verliebt?',
    subtitle: 'Entdecke die Wahrheit über deine Gefühle mit diesem wissenschaftlich fundierten Quiz. Antworte ehrlich basierend darauf, was du wirklich fühlst.',
    assessmentTitle: 'Diese Bewertung evaluiert:',
    commitment: 'Bindung und Zukunftsdenken',
    attraction: 'Physische und romantische Anziehung',
    authenticity: 'Authentizität und Verletzlichkeit',
    balance: 'Balance von Geben und Nehmen',
    question: 'Frage',
    of: 'von',
    quizCompleted: 'Quiz abgeschlossen!',
    yourAssessment: 'Deine Liebesbewertung',
    basedOnAnswers: 'Basierend auf deinen Antworten, zeigt sich folgendes über deine Gefühle',
    resultLabel: 'Dein Liebesbewertungsergebnis',
    loveScore: 'Liebespunktzahl',
    outOf: 'von',
    points: 'Punkten',
    whatThisMeans: 'Was das bedeutet',
    understandingFeelings: 'Deine Gefühle verstehen',
    scoreBreakdown: 'Deine Punkteaufschlüsselung',
    detailedAnalysis: 'Detaillierte Liebesbewertungsanalyse',
    overallLoveScore: 'Gesamte Liebespunktzahl',
    deeplyInLove: 'Tief verliebt',
    strongFeelings: 'Starke Gefühle',
    developing: 'Entwicklung',
    uncertain: 'Unsicher',
    notInLove: 'Nicht verliebt',
    deeplyInLoveRange: '80-100%',
    strongFeelingsRange: '60-79%',
    developingRange: '40-59%',
    uncertainRange: '20-39%',
    ...
    disclaimer: 'Dieses Quiz dient der Selbstreflexion und Unterhaltung. Liebe ist komplex und für jeden einzigartig. Vertraue deinen eigenen Gefühlen und Erfahrungen über jedes Quiz-Ergebnis hinaus.',
    shareYourResults: 'Teile deine Ergebnisse',
    letOthersDiscover: 'Lass andere auch ihre Gefühle entdecken!',
    yourLoveAssessment: 'Deine Liebesbewertung',
    shareOn: 'Teilen auf:',
  ...
  fr: {
    title: 'Suis-je amoureux(se) ?',
    subtitle: 'Découvrez la vérité sur vos sentiments avec ce quiz scientifiquement informé. Répondez honnêtement en fonction de ce que vous ressentez vraiment.',
    assessmentTitle: 'Cette évaluation examine :',
    commitment: "L'engagement et la réflexion sur l'avenir",
    attraction: "L'attraction physique et romantique",
    authenticity: "L'authenticité et la vulnérabilité",
    balance: "L'équilibre du donner et recevoir",
    question: 'Question',
    of: 'sur',
    quizCompleted: 'Quiz terminé !',
    yourAssessment: 'Votre évaluation amoureuse',
    basedOnAnswers: "D'après vos réponses, voici ce que révèlent vos sentiments",
    resultLabel: 'Résultat de votre évaluation amoureuse',
    loveScore: "Score d'amour",
    outOf: 'sur',
    points: 'points',
    whatThisMeans: 'Ce que cela signifie',
    understandingFeelings: 'Comprendre vos sentiments',
    scoreBreakdown: 'Répartition de votre score',
    detailedAnalysis: "Analyse détaillée de l'évaluation amoureuse",
    overallLoveScore: "Score d'amour global",
    deeplyInLove: 'Profondément amoureux',
    strongFeelings: 'Sentiments forts',
    developing: 'En développement',
    uncertain: 'Incertain',
    notInLove: 'Pas amoureux',
    deeplyInLoveRange: '80-100%',
    strongFeelingsRange: '60-79%',
    developingRange: '40-59%',
    uncertainRange: '20-39%',
    ...
    disclaimer: "Ce quiz est pour l'auto-réflexion et le divertissement. L'amour est complexe et unique pour chacun. Faites confiance à vos propres sentiments et expériences au-dessus de tout résultat de quiz.",
    shareYourResults: 'Partagez vos résultats',
    letOthersDiscover: 'Laissez les autres découvrir leurs sentiments aussi !',
    yourLoveAssessment: 'Votre évaluation amoureuse',
  ...
  es: {
    title: '¿Estoy enamorado/a?',
    subtitle: 'Descubre la verdad sobre tus sentimientos con este quiz científicamente informado. Responde honestamente según lo que realmente sientes.',
    assessmentTitle: 'Esta evaluación examina:',
    commitment: 'Compromiso y pensamiento de futuro',
    attraction: 'Atracción física y romántica',
    authenticity: 'Autenticidad y vulnerabilidad',
    balance: 'Equilibrio del dar y recibir',
    question: 'Pregunta',
    of: 'de',
    quizCompleted: '¡Quiz completado!',
    yourAssessment: 'Tu evaluación amorosa',
    basedOnAnswers: 'Según tus respuestas, esto es lo que revelan tus sentimientos',
    resultLabel: 'Resultado de tu evaluación amorosa',
    loveScore: 'Puntuación de amor',
    outOf: 'de',
    points: 'puntos',
    whatThisMeans: 'Qué significa esto',
    understandingFeelings: 'Comprender tus sentimientos',
    scoreBreakdown: 'Desglose de tu puntuación',
    detailedAnalysis: 'Análisis detallado de la evaluación amorosa',
    overallLoveScore: 'Puntuación general de amor',
    deeplyInLove: 'Profundamente enamorado',
    strongFeelings: 'Sentimientos fuertes',
    developing: 'En desarrollo',
    uncertain: 'Incierto',
    notInLove: 'No enamorado',
    deeplyInLoveRange: '80-100%',
    strongFeelingsRange: '60-79%',
    developingRange: '40-59%',
    uncertainRange: '20-39%',
    ...
    disclaimer: 'Este quiz es para autorreflexión y entretenimiento. El amor es complejo y único para cada persona. Confía en tus propios sentimientos y experiencias por encima de cualquier resultado de quiz.',
    shareYourResults: 'Comparte tus resultados',
    letOthersDiscover: '¡Deja que otros descubran sus sentimientos también!',
    yourLoveAssessment: 'Tu evaluación amorosa',
  ...
  ru: {
    title: 'Я влюблён/влюблена?',
    subtitle: 'Узнайте правду о своих чувствах с этим научно обоснованным тестом. Отвечайте честно, основываясь на том, что вы действительно чувствуете.',
    assessmentTitle: 'Эта оценка проверяет:',
    commitment: 'Обязательства и мысли о будущем',
    attraction: 'Физическое и романтическое влечение',
    authenticity: 'Аутентичность и уязвимость',
    balance: 'Баланс отдачи и получения',
    question: 'Вопрос',
    of: 'из',
    quizCompleted: 'Тест завершён!',
    yourAssessment: 'Ваша оценка любви',
    basedOnAnswers: 'Основываясь на ваших ответах, вот что раскрывают ваши чувства',
    resultLabel: 'Результат вашей оценки любви',
    loveScore: 'Счёт любви',
    outOf: 'из',
    points: 'баллов',
    whatThisMeans: 'Что это значит',
    understandingFeelings: 'Понимание ваших чувств',
    scoreBreakdown: 'Разбивка вашего счёта',
    detailedAnalysis: 'Детальный анализ оценки любви',
    overallLoveScore: 'Общий счёт любви',
    deeplyInLove: 'Глубоко влюблён',
    strongFeelings: 'Сильные чувства',
    developing: 'Развиваются',
    uncertain: 'Неясно',
    notInLove: 'Не влюблён',
    deeplyInLoveRange: '80-100%',
    strongFeelingsRange: '60-79%',
    developingRange: '40-59%',
    uncertainRange: '20-39%',
    ...
    disclaimer: 'Этот тест предназначен для самоанализа и развлечения. Любовь сложна и уникальна для каждого. Доверяйте своим собственным чувствам и опыту больше, чем любому результату теста.',
    shareYourResults: 'Поделитесь своими результатами',
    letOthersDiscover: 'Позвольте другим тоже узнать о своих чувствах!',
    yourLoveAssessment: 'Ваша оценка любви',
...
export default function AmIInLoveClient({
  lang,
  questions,
  results
}: AmIInLoveClientProps) {
  ...
  useEffect(() => {
    ...
    const savedResult = localStorage.getItem(`amIInLoveResult_${lang}`)
    const savedScore = localStorage.getItem(`amIInLoveScore_${lang}`)
  ...
  const calculateResults = (finalAnswers: number[]) => {
    ...
    localStorage.setItem(`amIInLoveResult_${lang}`, level)
    localStorage.setItem(`amIInLoveScore_${lang}`, totalScore.toString())
    localStorage.setItem(`amIInLoveTestDate_${lang}`, new Date().toISOString())
  }
  ...
  const handleSocialShare = (platform: string) => {
    ...
    const text = encodeURIComponent(
      `I just took the "${t.title}" quiz and got: ${result.title} (${percentage}% ${t.loveScore.toLowerCase()})! 💕\n\nTake the quiz to discover your feelings!`
    )
    const url = encodeURIComponent(window.location.origin + buildPath('/am-i-in-love'))
    ...
    switch (platform) {
      ...
      case 'telegram':
        ...
        break
      case 'copy':
        const copyText = `I just took the "${t.title}" quiz and got: ${result.title} (${percentage}% ${t.loveScore.toLowerCase()})! 💕\n\nTake the quiz to discover your feelings!\n\n${window.location.origin}${buildPath('/am-i-in-love')}`
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 animate-scale-in" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 mb-6 border border-rose-200">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-1">{t.yourLoveAssessment}</p>
                  <p className="text-2xl font-bold text-rose-600 mb-1">{result.title}</p>
                  <p className="text-lg font-semibold text-gray-700">
                    {percentage}% {t.loveScore}
                  </p>
                </div>
              </div>
          ...
          <div className={`relative bg-gradient-to-br ${result.color} p-10 md:p-16 text-white border-b-4 border-rose-500 overflow-hidden`}>
            ...
            <div className="relative text-center">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full mb-6 shadow-xl animate-pulse">
                <span className="text-6xl">{result.title.split(' ')[0]}</span>
              </div>
              ...
              <div className="max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                  ...
                  <span className="text-gray-600 font-medium">{t.loveScore}</span>
                </div>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{t.understandingFeelings}</p>
                </div>
              </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-700 font-semibold text-lg">{t.overallLoveScore}</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6">
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">{t.deeplyInLove}</div>
                    <div className="text-xs text-gray-500 mt-1">{t.deeplyInLoveRange}</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">{t.strongFeelings}</div>
                    <div className="text-xs text-gray-500 mt-1">{t.strongFeelingsRange}</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">{t.developing}</div>
                    <div className="text-xs text-gray-500 mt-1">{t.developingRange}</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">{t.uncertain}</div>
                    <div className="text-xs text-gray-500 mt-1">{t.uncertainRange}</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-600">{t.notInLove}</div>
                    <div className="text-xs text-gray-500 mt-1">{t.notInLoveRange}</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 p-5 rounded-2xl border-2 border-rose-200 shadow-lg mt-4 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-800">
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    ...
                    <span className="font-medium">{t.commitment}</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-pink-500">💖</span>
                    <span className="font-medium">{t.attraction}</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
