...
interface LoveLanguageDescription {
  title: string
  description: string
  tips: string[]
}
...
type Props = {
  lang: Locale
  questions: Question[]
  descriptions: Record<string, LoveLanguageDescription>
}

const translations = {
  en: {
    quizCompleted: 'Quiz Completed!',
    yourResults: 'Your Love Language Results',
    subtitle: 'Discover how you express and receive love',
    primaryLanguage: 'Your Primary Love Language',
    matchScore: 'Match Score',
    completeBreakdown: 'Complete Results Breakdown',
    breakdownSubtitle: 'All five love languages ranked by your responses',
    topMatch: 'Top Match',
    responses: 'responses',
    tipsTitle: 'Tips for',
    tipsSubtitle: 'Practical advice to strengthen your relationships',
    shareResults: 'Share Results',
    inviteFriends: 'Invite Friends',
    retakeQuiz: 'Retake Quiz',
    readArticles: 'Read Articles',
    importantNote: 'Important Note',
    noteText: 'Your results are saved locally in your browser. Share them with your partner or friends to learn more about each other and strengthen your relationships! 💕',
    question: 'Question',
    of: 'of',
    previous: 'Previous',
    shareTitle: 'Share Your Results',
    shareSubtitle: 'Invite your friends to discover their love language!',
    yourPrimaryLang: 'Your Primary Love Language',
    shareOn: 'Share on:',
    copyLink: 'Copy Link',
  ...
  de: {
    ...
    yourResults: 'Deine Liebessprachen-Ergebnisse',
    subtitle: 'Entdecke, wie du Liebe ausdrückst und empfängst',
    primaryLanguage: 'Deine primäre Liebessprache',
    matchScore: 'Übereinstimmung',
    completeBreakdown: 'Vollständige Ergebnisübersicht',
    breakdownSubtitle: 'Alle fünf Liebessprachen nach deinen Antworten geordnet',
    topMatch: 'Beste Übereinstimmung',
    responses: 'Antworten',
    tipsTitle: 'Tipps für',
    tipsSubtitle: 'Praktische Ratschläge zur Stärkung deiner Beziehungen',
    shareResults: 'Ergebnisse teilen',
    inviteFriends: 'Freunde einladen',
    retakeQuiz: 'Quiz wiederholen',
    readArticles: 'Artikel lesen',
    importantNote: 'Wichtiger Hinweis',
    noteText: 'Deine Ergebnisse werden lokal in deinem Browser gespeichert. Teile sie mit deinem Partner oder Freunden, um mehr übereinander zu erfahren! 💕',
    question: 'Frage',
    of: 'von',
    previous: 'Zurück',
    shareTitle: 'Ergebnisse teilen',
    shareSubtitle: 'Lade deine Freunde ein, ihre Liebessprache zu entdecken!',
    yourPrimaryLang: 'Deine primäre Liebessprache',
    shareOn: 'Teilen auf:',
  ...
  fr: {
    ...
    yourResults: 'Vos résultats de langage d\'amour',
    subtitle: 'Découvrez comment vous exprimez et recevez l\'amour',
    primaryLanguage: 'Votre langage d\'amour principal',
    matchScore: 'Score de correspondance',
    completeBreakdown: 'Résultats détaillés complets',
    breakdownSubtitle: 'Les cinq langages d\'amour classés selon vos réponses',
    topMatch: 'Meilleure correspondance',
    responses: 'réponses',
    tipsTitle: 'Conseils pour',
    tipsSubtitle: 'Conseils pratiques pour renforcer vos relations',
    ...
    noteText: 'Vos résultats sont enregistrés localement dans votre navigateur. Partagez-les pour mieux vous connaître ! 💕',
    question: 'Question',
    of: 'sur',
    previous: 'Précédent',
    shareTitle: 'Partager vos résultats',
    shareSubtitle: 'Invitez vos amis à découvrir leur langage d\'amour !',
    yourPrimaryLang: 'Votre langage d\'amour principal',
    shareOn: 'Partager sur :',
    copyLink: 'Copier le lien',
    copiedToClipboard: '✓ Copié dans le presse-papiers !'
  },
  es: {
    quizCompleted: '¡Test completado!',
    yourResults: 'Tus resultados de lenguaje del amor',
    subtitle: 'Descubre cómo expresas y recibes amor',
    primaryLanguage: 'Tu lenguaje del amor principal',
    matchScore: 'Puntuación',
    completeBreakdown: 'Desglose completo de resultados',
    breakdownSubtitle: 'Los cinco lenguajes del amor clasificados según tus respuestas',
    topMatch: 'Mejor coincidencia',
    responses: 'respuestas',
    tipsTitle: 'Consejos para',
    tipsSubtitle: 'Consejos prácticos para fortalecer tus relaciones',
    shareResults: 'Compartir resultados',
    inviteFriends: 'Invitar amigos',
    retakeQuiz: 'Repetir test',
    readArticles: 'Leer artículos',
    importantNote: 'Nota importante',
    noteText: 'Tus resultados se guardan localmente. ¡Compártelos para conocerse mejor! 💕',
    question: 'Pregunta',
    of: 'de',
    previous: 'Anterior',
    shareTitle: 'Compartir resultados',
    shareSubtitle: '¡Invita a tus amigos a descubrir su lenguaje del amor!',
    yourPrimaryLang: 'Tu lenguaje del amor principal',
  ...
  ru: {
    ...
    yourResults: 'Ваши результаты языка любви',
    subtitle: 'Узнайте, как вы выражаете и получаете любовь',
    primaryLanguage: 'Ваш основной язык любви',
    matchScore: 'Оценка',
    completeBreakdown: 'Полная разбивка результатов',
    breakdownSubtitle: 'Все пять языков любви, ранжированные по вашим ответам',
    topMatch: 'Лучшее совпадение',
    responses: 'ответов',
    tipsTitle: 'Советы для',
    tipsSubtitle: 'Практические советы для укрепления ваших отношений',
    shareResults: 'Поделиться',
    inviteFriends: 'Пригласить друзей',
    retakeQuiz: 'Пройти снова',
    readArticles: 'Читать статьи',
    importantNote: 'Важное примечание',
    noteText: 'Ваши результаты сохраняются локально. Поделитесь ими, чтобы лучше узнать друг друга! 💕',
    question: 'Вопрос',
    of: 'из',
    previous: 'Назад',
    shareTitle: 'Поделиться результатами',
    shareSubtitle: 'Пригласите друзей узнать их язык любви!',
    yourPrimaryLang: 'Ваш основной язык любви',
    shareOn: 'Поделиться:',
...
export default function LoveLanguageQuizClient({ lang, questions, descriptions }: Props) {
  ...
  const buildPath = (path: string) => lang === 'en' ? path : `/${lang}${path}`

  useEffect(() => {
    const savedResults = localStorage.getItem(`loveLanguageResults_${lang}`)
    if (savedResults) {
  ...
  const calculateResults = (finalAnswers: string[]) => {
    ...
    localStorage.setItem(`loveLanguageResults_${lang}`, JSON.stringify(sortedResults))
    localStorage.setItem(`loveLanguageTestDate_${lang}`, new Date().toISOString())
  }
  ...
  const handleSocialShare = (platform: string) => {
    ...
    const url = encodeURIComponent(window.location.origin + buildPath('/test'))
    ...
    switch (platform) {
      ...
      case 'telegram':
        ...
        break
      case 'copy':
        const copyText = `${primaryLanguage} (${percentage}%)! 💕\n\n${window.location.origin}${buildPath('/test')}`
  ...
  const handleInvite = () => {
    const inviteUrl = window.location.origin + buildPath('/test')
    const inviteText = `Take the Love Language Quiz! ${inviteUrl}`
  ...
  if (showResult && results.length > 0) {
    const primaryLanguage = results[0].language
    const languageInfo = descriptions[primaryLanguage]
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in" onClick={() => setShowShareModal(false)}>
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 animate-scale-in" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{t.shareTitle}</h3>
              ...
              <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 mb-6 border border-rose-200">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-1">{t.yourPrimaryLang}</p>
                  <p className="text-2xl font-bold text-rose-600 mb-1">{languageInfo.title}</p>
                  <p className="text-lg font-semibold text-gray-700">
                    {((results[0].score / questions.length) * 100).toFixed(0)}% {t.matchScore}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button onClick={() => handleSocialShare('twitter')} className="flex items-center justify-center gap-2 px-4 py-3 bg-sky-50 hover:bg-sky-100 text-sky-600 rounded-lg transition-all hover:scale-105 hover:shadow-md font-medium">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                    Twitter/X
                  </button>
                  <button onClick={() => handleSocialShare('facebook')} className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg transition-all hover:scale-105 hover:shadow-md font-medium">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                    Facebook
                  </button>
                  <button onClick={() => handleSocialShare('whatsapp')} className="flex items-center justify-center gap-2 px-4 py-3 bg-green-50 hover:bg-green-100 text-green-600 rounded-lg transition-all hover:scale-105 hover:shadow-md font-medium">
                  ...
                  <button onClick={() => handleSocialShare('telegram')} className="flex items-center justify-center gap-2 px-4 py-3 bg-cyan-50 hover:bg-cyan-100 text-cyan-600 rounded-lg transition-all hover:scale-105 hover:shadow-md font-medium">
                ...
                <button onClick={() => handleSocialShare('copy')} className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg font-semibold hover:from-rose-600 hover:to-pink-600 transition-all hover:shadow-lg">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-600 animate-fade-in-up animation-delay-400">{t.subtitle}</p>
        </div>
            ...
            <div className="relative text-center">
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                  ...
                  <span className="text-gray-600 font-medium">{t.matchScore}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h3 className="text-3xl font-bold text-gray-900">{t.completeBreakdown}</h3>
                  <p className="text-gray-600">{t.breakdownSubtitle}</p>
                </div>
              </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-2">
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-sm text-gray-600 font-medium">
                            {result.score}/{questions.length} {t.responses}
                          </span>
            ...
            <div className="mb-12 p-8 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl border-2 border-blue-200 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-3xl font-bold text-blue-900">{t.tipsTitle} {languageInfo.title}</h3>
                  <p className="text-blue-700">{t.tipsSubtitle}</p>
                </div>
              </div>
              <div className="grid gap-4">
                {languageInfo.tips.map((tip, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 bg-white/80 backdrop-blur-sm rounded-xl hover:bg-white hover:shadow-md transition-all duration-300 group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              <button onClick={handleShare} className="group relative px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl font-semibold hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 cursor-pointer overflow-hidden">
              ...
              <button onClick={handleInvite} className="group relative px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 cursor-pointer overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                <svg className="w-6 h-6 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                <span className="relative z-10">{t.inviteFriends}</span>
              </button>

              <button onClick={resetQuiz} className="group relative px-6 py-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-xl font-semibold hover:from-rose-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 cursor-pointer overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                <svg className="w-6 h-6 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                <span className="relative z-10">{t.retakeQuiz}</span>
              </button>

              <Link href={buildPath('/articles')} className="group relative px-6 py-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl font-semibold hover:from-gray-700 hover:to-gray-800 transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 cursor-pointer overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-300 p-6 rounded-2xl shadow-md">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-amber-800 leading-relaxed">{t.noteText}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {currentQuestion === 0 && (
            <div className="mb-6 text-center pb-6 border-b-2 border-gradient-to-r from-rose-200 via-pink-200 to-purple-200">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold mb-3 bg-gradient-to-r from-rose-600 via-pink-600 to-purple-600 bg-clip-text text-transparent leading-tight">
                {lang === 'en' ? 'Love Language Quiz' :
                  lang === 'de' ? 'Liebessprachen-Quiz' :
                  lang === 'fr' ? 'Quiz Langages d\'Amour' :
                  lang === 'es' ? 'Test de Lenguajes del Amor' :
                  'Тест языков любви'}
              </h1>
              <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto mb-5 font-medium">
                {lang === 'en' ? 'Discover how you express and receive love. Understanding your love language can transform your relationships and help you connect more deeply with those you care about.' :
                  lang === 'de' ? 'Entdecke, wie du Liebe ausdrückst und empfängst. Das Verständnis deiner Liebessprache kann deine Beziehungen transformieren.' :
                  lang === 'fr' ? 'Découvrez comment vous exprimez et recevez l\'amour. Comprendre votre langage d\'amour peut transformer vos relations.' :
                  lang === 'es' ? 'Descubre cómo expresas y recibes amor. Comprender tu lenguaje del amor puede transformar tus relaciones.' :
                  'Узнайте, как вы выражаете и получаете любовь. Понимание вашего языка любви может изменить ваши отношения.'}
              </p>
            </div>
          )}
