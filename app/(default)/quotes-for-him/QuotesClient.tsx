      ...
      <div className="relative overflow-hidden py-20 px-4">
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Love Quotes{' '}
            <span className="text-blue-600">for Him</span>
          </h1>
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <div className="flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg transition-all duration-200 text-sm font-semibold group"
                    >
                      {copiedId === quote.id ? (
                        <>
