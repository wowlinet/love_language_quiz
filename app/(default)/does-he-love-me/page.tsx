...
export default function DoesHeLoveMePage() {
  ...
  const handleSocialShare = (platform: string) => {
    ...
    const text = encodeURIComponent(
      `I just took the "Does He/She Love Me?" quiz! 💕\n\nDiscover important insights about your relationship!`
    )
    const url = encodeURIComponent(window.location.origin + '/does-he-love-me')
    ...
    switch (platform) {
      ...
      case 'telegram':
        ...
        break
      case 'copy':
        const copyText = `I just took the "Does He/She Love Me?" quiz and discovered important insights! 💕\n\nTake the quiz to evaluate your relationship:\n\n${window.location.origin}/does-he-love-me`
  ...
  if (showResult && resultLevel) {
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Share Modal - optimized for does-he-love-me */}
        {showShareModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in" onClick={() => setShowShareModal(false)}>
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 animate-scale-in" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Share Your Assessment</h3>
                <p className="text-gray-600">Help others evaluate their relationships!</p>
              </div>
              <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 mb-6 border border-rose-200">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-1">Relationship Assessment</p>
                  <p className="text-2xl font-bold text-rose-600 mb-1">{result.title}</p>
                  <p className="text-lg font-semibold text-gray-700">{percentage}% Love Score</p>
                </div>
              </div>
          ...
          {currentQuestion === 0 && (
            <div className="mb-6 text-center pb-6 border-b-2 border-gradient-to-r from-rose-200 via-pink-200 to-purple-200">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto mb-5 font-medium">
                ...
                on consistent patterns you&apos;ve observed.
              </p>
              <div className="bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 p-5 rounded-2xl border-2 border-rose-200 shadow-lg mt-4 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-800">
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    ...
                    <span className="font-medium">Emotional support & empathy</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-blue-500">🤝</span>
                    <span className="font-medium">Respect & trust</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-pink-500">💖</span>
                    <span className="font-medium">Affection & prioritization</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-purple-500">💬</span>
                    <span className="font-medium">Communication & conflict resolution</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-green-500">🌱</span>
                    <span className="font-medium">Support for your growth</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/60 p-3 rounded-lg hover:bg-white/80 transition-all">
                    <span className="text-indigo-500">🔮</span>
                    <span className="font-medium">Commitment & future planning</span>
                  </div>
                </div>
              </div>
            </div>
